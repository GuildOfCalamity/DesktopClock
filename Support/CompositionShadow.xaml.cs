...
/// I have raised the default blur radius from 8 to 12.
...
/// but we can add a converter method so that passing a <see cref="SolidColorBrush"/> does not crash
/// the control.
/// </remarks>
...
public sealed partial class CompositionShadow : UserControl
{
    ...
    public static readonly DependencyProperty BlurRadiusProperty = DependencyProperty.Register(
            ...
            new PropertyMetadata(12.0, OnBlurRadiusChanged));
